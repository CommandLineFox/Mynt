...
const ArrayArgument_1 = __importDefault(require("../../command/arguments/ArrayArgument"));
const BooleanArgument_1 = __importDefault(require("../../command/arguments/BooleanArgument"));
const GuildArgument_1 = __importDefault(require("../../command/arguments/GuildArgument"));
const MemberArgument_1 = __importDefault(require("../../command/arguments/MemberArgument"));
const NumberArgument_1 = __importDefault(require("../../command/arguments/NumberArgument"));
const StringArgument_1 = __importDefault(require("../../command/arguments/StringArgument"));
const UserArgument_1 = __importDefault(require("../../command/arguments/UserArgument"));
